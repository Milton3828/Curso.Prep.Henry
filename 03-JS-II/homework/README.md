...
* `for` es un bucle que se utiliza para repetir una o mas instrucciones.
* `&&`, `||`, `!`  son operadores logicos que nos permiten  comparar con una cierta condicion y el resultado siempre es booleano ( true, false)
